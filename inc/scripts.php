...
function mdlwp_scripts() {
        /* 
         * slednite ne sa aktualni
         * izpolzva se samo edin file
         * i toi e localno v inc
         * customize and download: https://getmdl.io/customize/index.html#cdn-code
         */
	//$primary = get_theme_mod( 'primary_color', 'blue' );
	//$secondary = get_theme_mod( 'secondary_color', 'light blue' );
	//wp_enqueue_style( 'mdlwp-mdl-css', '//storage.googleapis.com/code.getmdl.io/1.1.3/material.'.$primary.'-'.$secondary.'.min.css' );
        
	wp_enqueue_style( 'mdlwp-mdl-css', get_template_directory_uri() . '/inc/material.grey-light_green.min.css' );
